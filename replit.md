...
- Confirmed custom domain: `bluedragonflyhealthandwellness.com` (with the "e" in blue; user briefly switched to bluedragonflyhw.com in July 2026 then reverted) — used in SEO canonical URLs, `public/sitemap.xml`, and `public/robots.txt`
