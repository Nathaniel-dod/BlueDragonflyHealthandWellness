...
- SEO canonical URLs, `public/sitemap.xml`, and `public/robots.txt` all use the placeholder domain `bluedragonflywellness.com` — update all three when the real custom domain is confirmed (wrong canonicals on the live domain hurt indexing)
